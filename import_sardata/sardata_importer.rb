    ...
    DEFINITIONS = [
      ...
      },
      {
        :type => "memory", :fields => {
          ...
          "kbanonpg"  => { :col_name => "kbanonpg",    :data_type => :long },
          "kbslab"    => { :col_name => "kbslab",      :data_type => :long },
          "kbkstack"  => { :col_name => "kbkstack",    :data_type => :long },
          "kbpgtbl"   => { :col_name => "kbpgtbl",     :data_type => :long },
          "kbvmused"  => { :col_name => "kbvmused",    :data_type => :long },
